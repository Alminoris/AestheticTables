...
public class Table extends Block implements Waterloggable
{
    ...
    protected static final VoxelShape LEG_1 = Block.createCuboidShape(13.0D, 0.0D, 1.0D, 15.0D, 13.5D, 3.0D);  // NE
    protected static final VoxelShape LEG_2 = Block.createCuboidShape(13.0D, 0.0D, 13.0D, 15.0D, 13.5D, 15.0D); // SE
    protected static final VoxelShape LEG_3 = Block.createCuboidShape(1.0D, 0.0D, 13.0D, 3.0D, 13.5D, 15.0D);   // SW
    protected static final VoxelShape LEG_4 = Block.createCuboidShape(1.0D, 0.0D, 1.0D, 3.0D, 13.5D, 3.0D);     // NW
